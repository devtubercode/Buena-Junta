...
export const CartButton = ({ className, iconClassName }: CartButtonProps) => {
  ...
  return (
    ...
    >
      ...
      {totalQuantity > 0 && (
        <span className="absolute right-0 top-0 inline-flex min-h-4 min-w-4 -translate-y-1/3 translate-x-1/3 items-center justify-center rounded-full border border-background bg-primary px-1 text-[10px] font-black leading-none text-primary-foreground shadow-elevated">
