...
export function CategoriesPage() {
  ...
  useEffect(() => {
    ...
    if (nameValue && !slugValue) {
      setValue("slug", normalizeSlug(nameValue), { shouldValidate: true });
    }
  }, [nameValue, selected, getValues, setValue]);
  ...
  const onSubmit = async (data: CategoryFormData) => {
    ...
    try {
      ...
      notify.success(selected ? "Categoría actualizada." : "Categoría creada.");
      closeModal();
      setSelected(null);
      reset(defaultValues);
      await reload();
