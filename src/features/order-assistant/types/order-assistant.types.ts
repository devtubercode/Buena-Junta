...
export type OrderAssistantActions = {
  ...
  generateSuggestion: (products: import("@/features/menu/types/menu.types").MenuProduct[], categories: import("@/features/menu/types/menu.types").MenuCategory[], promotions?: import("@/features/home/types/promotion.types").Promotion[], additions?: import("@/features/admin/types/additions.types").AdditionRow[]) => void;
